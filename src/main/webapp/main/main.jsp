                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-info">
                                    <a href="javascript:$('#mainId').load('${path}/test/echarts.jsp')">用户统计</button><br><br>
                                <button class="btn btn-info">
                                    <a href="javascript:$('#mainId').load('${path}/test/userChina.jsp')">用户分布</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <button class="btn btn-success">
                                    <a href="javascript:$('#mainId').load('${path}/category/showCategory.jsp')">类别信息</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <button class="btn btn-warning">
                                    <a href="javascript:$('#mainId').load('${path}/video/showVideo.jsp')"/>视频信息 </button>
                            </div>
                            <div class="panel-body">
                                <button class="btn btn-warning">
                                    <a href="javascript:$('#mainId').load('${path}/video/searchVideo.jsp')"/>视频检索 </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-danger">
                                    <a href="javascript:$('#mainId').load('${path}/main/admin.jsp')">管理员信息</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
                            <div class="panel-body">
                                <button class="btn btn-primary">
                                    <a href="javascript:$('#mainId').load('${path}/log/showLog.jsp')">日志信息</button>
                            </div>
                        </div>
                    </div>
